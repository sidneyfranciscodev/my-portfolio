  ...
  <div class="project">
    ...
    <div v-if="links && Object.keys(links).length" class="links">
      <a
        ...
        :title="label"
      >
        <svg v-if="label === 'Github'" class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <svg v-else-if="label === 'Live'" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
